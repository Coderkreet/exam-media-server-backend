...
// ✅ Create Producer (Student sends media)
app.post('/api/produce', async (req, res) => {
  try {
    const { peerId, kind, rtpParameters, examId } = req.body;
    
    console.log(`📺 Creating producer for peer ${peerId}, kind: ${kind}`);
